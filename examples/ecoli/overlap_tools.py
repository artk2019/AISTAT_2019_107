...
# -*- coding: utf-8 -*-
"""
Tools for the de novo genome assembly experiment
"""
import numpy as np
import pandas as pd
...
# ###############################################################
# Handle the overlaps between reads to get the similarity matrix
# ###############################################################
class MiniOvl:
...
def build_sim_mat(ovlp_fn, reads_fn, ovlp_thr=500):
    """
