...
$MINIMAP -x ava-ont ${THISDIR}/ecoli_data/reads.fasta ${THISDIR}/ecoli_data/reads.fasta > ${THISDIR}/results/ovlp.paf

# Run minimap2 to get the ground truth position of the reads on the genome
$MINIMAP -ax map-ont ${THISDIR}/ecoli_data/ref/ref.fna ${THISDIR}/ecoli_data/reads.fasta > ${THISDIR}/results/aln.sam
